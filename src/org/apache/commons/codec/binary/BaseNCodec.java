...
public abstract class BaseNCodec implements BinaryEncoder, BinaryDecoder {
	 ...
	 */
	protected BaseNCodec(int unencodedBlockSize, int encodedBlockSize,
	...
	abstract void encode(byte[] pArray, int i, int length);  // package protected
															// for access from
															// I/O streams
	
	abstract void decode(byte[] pArray, int i, int length); // package protected
															// for access from
															// I/O streams
	 ...
	 * @param allowWSPad if <code>true</code>, then whitespace and PAD are also
	 *        allowed
	 * 
