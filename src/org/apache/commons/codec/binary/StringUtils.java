...
public class StringUtils {
	 ...
	 * charset, storing the result into a new byte array. <p> This method
	 * catches {@link UnsupportedEncodingException} and rethrows it as
	 * {@link IllegalStateException}, which should never happen for a required
	 * charset name. Use this method when the encoding is required to be in the
	 * JRE. </p>
	 * 
	 * @param string the String to encode, may be <code>null</code>
	 * @param charsetName The name of a required
	 *        {@link java.nio.charset.Charset}
	 * @return encoded bytes, or <code>null</code> if the input string was
	 *         <code>null</code>
	 * @throws IllegalStateException Thrown when a
	 *         {@link UnsupportedEncodingException} is caught, which should
	 *         never happen for a required charset name.
	 * @see CharEncoding
	 ...
	 * bytes using the given charset. <p> This method catches
	 * {@link UnsupportedEncodingException} and re-throws it as
	 * {@link IllegalStateException}, which should never happen for a required
	 * charset name. Use this method when the encoding is required to be in the
	 * JRE. </p>
	 * 
	 ...
	 * @throws IllegalStateException Thrown when a
	 *         {@link UnsupportedEncodingException} is caught, which should
	 *         never happen since the charset is required.
	 */
