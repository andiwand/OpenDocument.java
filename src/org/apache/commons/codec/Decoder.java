...
/**
 * <p>Provides the highest level of abstraction for Decoders. This is the sister
...
public interface Decoder {
	 ...
	 *         of reasons. Some good candidates are that the parameter passed to
	 *         this method is null, a param cannot be cast to the appropriate
