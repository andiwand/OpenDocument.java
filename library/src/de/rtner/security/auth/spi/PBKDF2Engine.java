...
/**
 * <p> Request for Comments: 2898 PKCS #5: Password-Based Cryptography
 * Specification <p> Version 2.0
 * 
 * <p> PBKDF2 (P, S, c, dkLen)
 * 
 * <p> Options: <ul> <li>PRF underlying pseudorandom function (hLen denotes the
 * length in octets of the pseudorandom function output). PRF is pluggable.</li>
 * </ul>
 * 
 * <p> Input: <ul> <li>P password, an octet string</li> <li>S salt, an octet
 * string</li> <li>c iteration count, a positive integer</li> <li>dkLen intended
 * length in octets of the derived key, a positive integer, at most (2^32 - 1) *
 * hLen</li> </ul>
 * 
 * <p> Output: <ul> <li>DK derived key, a dkLen-octet string</li> </ul>
 * 
 * <hr /> <p> A free Java implementation of Password Based Key Derivation
 * Function 2 as defined by RFC 2898. Copyright (c) 2007 Matthias G&auml;rtner
 * </p> <p> This library is free software; you can redistribute it and/or modify
 * it under the terms of the GNU Lesser General Public License as published by
 * the Free Software Foundation; either version 2.1 of the License, or (at your
 * option) any later version. </p> <p> This library is distributed in the hope
 * that it will be useful, but WITHOUT ANY WARRANTY; without even the implied
 * warranty of MERCHANTABILITY or FITNESS FOR A PARTICULAR PURPOSE. See the GNU
 * Lesser General Public License for more details. </p> <p> You should have
 * received a copy of the GNU Lesser General Public License along with this
 * library; if not, write to the Free Software Foundation, Inc., 51 Franklin
 * Street, Fifth Floor, Boston, MA 02110-1301 USA </p> <p> For Details, see <a
 * href
 * ="http://www.gnu.org/licenses/old-licenses/lgpl-2.1.html">http://www.gnu.org
 * /licenses/old-licenses/lgpl-2.1.html</a>. </p>
 * 
